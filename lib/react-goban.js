			...
			render: function render() {
						...
						return React.createElement(
									...
									React.createElement(
												...
												React.createElement(LabelsLayer, { size: this.props.size, coordSystem: this.props.coordSystem }),
												...
												React.createElement(MarkersLayer, { size: this.props.size, markers: this.props.markers, positions: this.props.stones })
									)
						);
			}
});
